...
char this_anchor_addr[] = "A1:00:22:EA:82:60:3B:9C";
uint16_t Adelay = 16480; //starting value
uint16_t Adelay_delta = 1000; //initial binary search step size
...
void setup() {
  ...
  // init UWB Transciever
  SPI.begin(SPI_SCK, SPI_MISO, SPI_MOSI);
  DW1000Ranging.initCommunication(PIN_RST, PIN_SS, PIN_IRQ); //Reset, CS, IRQ pin

  DW1000Ranging.attachNewRange(measureDistance);
  DW1000Ranging.startAsAnchor(this_anchor_addr, DW1000.MODE_SHORTDATA_FAST_ACCURACY, false);
}
